...
def test_simple_scene_is_valid(catalogue: Catalogue) -> None:
...
def test_unknown_catalogue_name_and_port(catalogue: Catalogue) -> None:
    scene = simple_scene()
...
def test_type_mismatch(catalogue: Catalogue) -> None:
    scene = simple_scene()
...
def test_missing_required(catalogue: Catalogue) -> None:
    scene = simple_scene()
    scene.edges = []
    issues = validate_scene(scene, catalogue)
...
def test_steps_are_checked(catalogue: Catalogue) -> None:
    scene = simple_scene()
